...
original_author="ccxx72"
original_name="lam"
original_urlname="lam"
original_description="Awesome lam created by ccxx72" 
...
then
    ...
    echo "then run 'lam' or 'python -m lam'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'lam' or 'python -m lam' or 'poetry run lam'"
fi
